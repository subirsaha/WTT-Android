...
public class TwitterConnect extends CordovaPlugin {
	...
	public void initialize(CordovaInterface cordova, CordovaWebView webView) {
		...
		Fabric.with(cordova.getActivity().getApplicationContext(), new Twitter(new TwitterAuthConfig("h1stkjAfPnrFZcN89x5UCPNGd", "2vXl0TnFgtwlSeSrlJgiLDNCDG5F9izseQTQvlPPdHrzvCOUfa")));
